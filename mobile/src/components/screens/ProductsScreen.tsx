...
import type { FilterValues } from '../ui/FilterSheet';
import { useDebounce } from '../../hooks/useDebounce';
import { categories } from '../../utils/constants';
import { getProductsApi, getSuggestProductsApi } from '../../api/endpoints/products';
import { imageSearchApi } from '../../api/endpoints/imageSearch';
...
export default function ProductsScreen({ showBackButton = true }: Props) {
  ...
  // Reset filters, search and suggestions when navigating away from this screen
  useFocusEffect(
    useCallback(() => {
      return () => {
